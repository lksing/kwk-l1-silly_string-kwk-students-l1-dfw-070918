...
your_favorite_word = "Scintillating"

puts "My favorite word is " + your_favorite_word

# Challenge 2: Capitalize every letter in your_favorite_word using a built in Ruby method

favorite_word_in_all_caps = "Scintillating".upcase # Put a . after your_favorite word and use a String method.
...
letter_count = big_word.length.to_s # Put a . after big_word and use a String method. 
...
puts "There are now " + new_letter_count.to_s + " letters in " + bigger_word
